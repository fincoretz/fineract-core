...
public class TenantNotFoundException extends AbstractPlatformResourceNotFoundException {
    ...
    public TenantNotFoundException(final String tenantIdentifier) {
        super("error.msg.tenant.identifier.invalid", "Tenant with identifier `" + tenantIdentifier + "` does not exist",
                tenantIdentifier);
    }
}
